...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
  <h1 class="text-3xl sm:text-4xl font-black tracking-tight mb-8">Sitemap</h1>

  <div class="space-y-10">
    <section>
      <h2 class="text-xl font-bold mb-4 text-violet-600 dark:text-violet-400">Main Pages</h2>
      <ul class="space-y-3">
        <li class="flex flex-wrap items-center gap-2">
          <a href="{{ '/' | relative_url }}" class="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Home</a>
        ...
        <li class="flex flex-wrap items-center gap-2">
          <a href="{{ '/about/' | relative_url }}" class="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">About</a>
          <span class="text-gray-400 dark:text-gray-600 text-xs">|</span>
        ...
        <li class="flex flex-wrap items-center gap-2">
          <a href="{{ '/contact/' | relative_url }}" class="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Contact</a>
          <span class="text-gray-400 dark:text-gray-600 text-xs">|</span>
        ...
        <li class="flex flex-wrap items-center gap-2">
          <a href="{{ '/submit/' | relative_url }}" class="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Submit a Methodology</a>
          <span class="text-gray-400 dark:text-gray-600 text-xs">|</span>
    ...
    <section>
      <h2 class="text-xl font-bold mb-4 text-violet-600 dark:text-violet-400">Methodologies</h2>
      <ul class="space-y-3">
        {% assign sorted = site.data.methodologies | sort: "acronym" %}
        {% for m in sorted %}
          <li class="flex flex-wrap items-center gap-2">
